...
<a href="psd2026ganjil.qmd" class="btn btn-outline-primary mb-4"> <i class="fa-solid fa-arrow-left"></i> Kembali ke arsip PSD </a>
...
    - `R-4.4.1-arm64.pkg` untuk Mac M1, M2 dan seterusnya, yaitu menggunakan prosesor Apple Silicon         - `R-4.4.1-x86_64.pkg` untuk Mac yang dirilis sebelum M1, yaitu menggunakan prosesor Intel
...
    Tekan tombol "Download" di sebelah kanan, apabila memenuhi kriteria versi *operating system* yang digunakan.         Apabila tidak memenuhi, kunjungi <https://dailies.rstudio.com/rstudio/> dan carilah versi RStudio yang kompatibel dengan versi *operating system* yang digunakan. Tampilan *website* tersebut seperti berikut.
...
## Menggunakan R di Google Colab

Bagi kalian yang ingin menggunakan R secara *online*, kalian ternyata bisa loh menggunakan Google Colaboratory. Kalian tinggal ikuti langkah berikut:

1.  Kunjungi <https://colab.research.google.com/> dan buat *notebook* baru.

2.  Pilih *runtime* pada menu bagian atas.

    ![](https://raw.githubusercontent.com/aslab-math-ui/asset/main/pengantar_sains_data/static/colab_2.png)

3.  Pilih *change runtime type* dan pilih R.

    ![](https://raw.githubusercontent.com/aslab-math-ui/asset/main/pengantar_sains_data/static/colab_1.png)

    ![](https://raw.githubusercontent.com/aslab-math-ui/asset/main/pengantar_sains_data/static/colab_3.png)

## Pengenalan R lebih detail

## Operasi Dasar

Layaknya bahasa pemrograman pada umumnya, R tentunya dapat melakukan operasi dasar.
...
Jika sebelumnya kita berbicara operasi pada angka, kini kita akan menggunakan **array** dan **vektor**. Untuk mengingat kembali apa itu array, array adalah struktur data dalam pemrograman yang digunakan untuk menyimpan sekumpulan data dengan tipe data yang sama di dalam satu nama variabel.

Tentunya jenis data ini akan banyak kita gunakan nantinya, karena bermain dengan data.
...
Sama seperti pada Python, operasi-operasi pada array tentunya bisa dilakukan dengan mudah tanpa harus membuat fungsi lebih lanjut
```{r}
  x <- c(1, 2, 3)
  y <- c(4, 5, 6)
  
  # Penjumlahan: c(1+4, 2+5, 3+6) -> 5 7 9
  x + y 
  
  # Perkalian: c(1*4, 2*5, 3*6) -> 4 10 18
  x * y 
  
  # Operasi dengan Skalar (angka tunggal): setiap elemen dikali 2 -> 2 4 6
  x * 2 
```
...
<a href="psd2026ganjil.qmd" class="btn btn-outline-primary mb-4"> <i class="fa-solid fa-arrow-left"></i> Kembali ke Arsip Praktikum PSD 2025 </a>
