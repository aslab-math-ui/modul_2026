...
description: "Deadline: Minggu, 19 April 2026"
date: 03/17/2026
...
10. Sesuai standar Universitas Indonesia, **plagiarisme dilarang keras** dan bisa menyebabkan nilai tugas praktikum **menjadi nol untuk semua pihak yang terlibat, tanpa peringatan apapun.** Namun, Anda boleh memanfaatkan kode apapun yang ada di [modul praktikum](./saindat2026genap.qmd).

11. Narahubung:

    - Tugas 1 Saindat: Jason (Line: jack550k)
    - Umum: Dimas (Wa : 0895611364100, Line : dimas.p.u)


# Soal

Dataset yang digunakan adalah dataset harga properti rumah, `house_prices.csv`, yang bisa di-*download* dari tautan berikut (gunakan Ctrl + S jika tidak otomatis tersimpan):

<a href="https://raw.githubusercontent.com/aslab-math-ui/asset/main/sains_data/datasets/house_prices.csv"
...
c. Lakukan ***train-test-split*** (rasio dibebaskan, misal 80:20). Jangan lupa gunakan suatu `random_state`.
