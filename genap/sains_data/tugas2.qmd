...
6. Pengumpulan tugas dilakukan ke Google Forms berikut ini, sesuai dengan kelas Anda di SIAK NG (link akan selalu sama untuk semua tugas praktikum Sains Data):
    ...
    - Kelas A dan B: <https://docs.google.com/forms/d/e/1FAIpQLScVXON0gmiBZSfbdlJyoMJtY_lDz7RTbXEO9ORQoprwIkz-SA/viewform?usp=header>
...
Diberikan dataset `heart_disease_uci.csv` yang berisi data pengajuan klaim asuransi kendaraan yang diajukan oleh para tertanggung (nasabah). Dataset dapat di-*download* pada tautan berikut:
