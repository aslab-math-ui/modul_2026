...
<a href="https://raw.githubusercontent.com/aslab-math-ui/asset/main/sains_data/datasets/heart_disease_uci.csv"
   download="insurance_claims.csv"
   class="btn">
   Download Dataset
</a>
...
<a href="./tugas2/heart_disease_data_description.qmd" class="btn">Deskripsi Fitur</a>
...
d. ***Modelling:*** Buatlah minimal satu model untuk setiap metode klasifikasi yang sudah diajarkan, yakni:
